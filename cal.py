            ...
            if match and current_title:
                ...
                try:
                    ...
                    event_time = datetime.datetime.combine(
                        today, datetime.time(hours, minutes)
                    )
                    ...
                    if (
                        ...
                        and (current_time - event_time).total_seconds() > 3600
                    ):
                        continue
...
def display_fullscreen_reminder(event_title: str) -> None:
    ...
    script_path = os.path.join(
        os.path.dirname(os.path.abspath(__file__)), "reminder_window.py"
    )
...
def main() -> None:
    ...
    while True:
        ...
        if (
            ...
            or (current_time - last_check_time).total_seconds() >= 60
        ):
